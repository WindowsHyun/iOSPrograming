...
//  ScroolViews
//
//  Created by HyunWindows on 2016. 4. 21..
...
class ViewController: UIViewController, UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        //1. photo1.png로 부터 이미지 뷰를 생성(파일이 없으면 crash!)
        ...
        // 4. 최대 줌아웃 했을 떄 전체 이미지를 한 화면에 보기 위한 minimumZiimScale 설정
        // width, height에 대해서 스크롤프레임크기/이미지 크기를 구하고 최소값으로 설정
